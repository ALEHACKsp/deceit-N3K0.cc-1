...
public:
	...
	void drawText(const Vec2& pos, const std::string& text, const Color& color, std::uint32_t flags = FW1_LEFT,
		float fontSize = 10.f, const std::wstring & fontFamily = {});

	void drawText(const Vec2& pos, const Color& color, std::uint32_t flags , float fontSize  ,const char* text,...);
